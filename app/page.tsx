...
const tools = [
  { name: 'UNMARK', title: 'NotebookLM 去水印', description: '批量清理 PDF / PPTX 水印，导出后还可添加自己的 Logo 或文字标识。', href: 'https://unmark.tinylabpro.com/', category: '文档处理', status: 'NEW', logo: '/unmark-logo-128.webp', tone: 'blue', tags: ['文档处理', '手机可用'] },
  { name: 'TEACH', title: '教师工具箱', description: '备课、课堂与日常教学轻量工具合集，减少重复操作。', href: 'https://teach.tinylabpro.com/', category: '教师工具', status: '已上线', logo: '/teach-logo-128.webp', tone: 'green', tags: ['教师工具', '打开即用'] },
  { name: 'STUDY', title: '学生工具箱', description: '面向自主学习、练习与备考的轻量工具集合，让学习任务更好开始。', href: 'https://study.tinylabpro.com/', category: '学生工具', status: '已上线', logo: '/study-logo-128.webp', tone: 'violet', tags: ['学生工具', '自主学习'] },
  { name: 'KEYSCAN', title: '本地安全工具箱', description: '密码、OTP、加密备份与本地安全工具，重要数据尽量留在自己手里。', href: 'https://keyscan.tinylabpro.com/', category: '隐私安全', status: '开源', logo: '/keyscan-logo-128.webp', tone: 'amber', tags: ['隐私安全', '本地优先', '开源'] },
  { name: 'TINY OTP', title: 'OTP 动态验证码', description: '无需登录即可管理动态验证码，支持加密备份和 WebDAV 同步。', href: 'https://otp.tinylabpro.com/', category: '隐私安全', status: '已上线', logo: '/otp-logo-128.webp', tone: 'blue', tags: ['微信小程序', '无需登录', 'WebDAV'] },
  { name: 'SECURE SURVEY', title: '加密调查问卷', description: '提交前完成加密的隐私问卷工具，为敏感信息多留一层保护。', href: 'https://survey.tinylabpro.com/', category: '隐私安全', status: '已上线', logo: '/survey-logo-128.webp', tone: 'violet', tags: ['隐私安全', '无需安装'] },
  { name: 'IMAGE', title: '图片工坊', description: '证件照、压缩、改尺寸、去背景等 9 个图片工具，照片默认不离开你的浏览器。', href: 'https://image.tinylabpro.com/', category: '图片处理', status: '已上线', logo: '/image-toolbox-logo-128.webp', tone: 'rose', tags: ['图片处理', '浏览器本地处理'] },
  { name: 'ADDRESS GEN', title: '全球地址与人物资料生成器', description: '按 249 个国家 / 地区的本地格式生成地址与人物资料，浏览器本地生成，可批量导出。', href: 'https://addressgen.tinylabpro.com/', category: '实用工具', status: '已上线', logo: '/address-generator-logo-128.webp', tone: 'green', tags: ['249 国', '16 种语言', '可离线'] },
];
  ...
  return <main className="min-h-screen bg-[radial-gradient(900px_360px_at_92%_-150px,rgba(41,84,232,.12),transparent_72%),#f7f8fc] text-slate-950">
    ...
    <section id="top" className="border-b border-slate-200/80 bg-transparent px-5 pb-8 pt-13 sm:px-8 sm:pb-9 sm:pt-17">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-7 flex flex-col gap-3 sm:flex-row"><a href="#tools" className={cn(buttonVariants({ size: 'lg' }), 'h-11 rounded-xl bg-[#2954e8] px-5 shadow-[0_10px_24px_rgba(41,84,232,.18)] hover:bg-[#2145c7]')}>浏览全部工具 <ArrowDown data-icon="inline-end" /></a><a href="https://unmark.tinylabpro.com/" target="_blank" rel="noopener noreferrer" className={cn(buttonVariants({ variant: 'outline', size: 'lg' }), 'h-11 rounded-xl border-slate-300 bg-white px-5 text-slate-800')}>最新：NotebookLM 去水印 <ArrowUpRight data-icon="inline-end" /></a></div>
      </div>
    </section>
