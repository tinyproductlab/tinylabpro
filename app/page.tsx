...
export default function Home() {
  ...
  return <main className="min-h-screen overflow-hidden">
    ...
    <section id="top" className="relative border-b border-slate-200 bg-[#f7f8fc]">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-18 sm:px-8 sm:py-24 lg:grid-cols-[1.12fr_.88fr] lg:items-center lg:py-28">
        <div>
    ...
    <section id="about" className="bg-[#101d49] px-5 py-20 text-white sm:px-8 sm:py-24"><div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[.85fr_1.15fr] lg:items-end"><div><p className="font-mono text-xs tracking-[0.18em] text-blue-300">ABOUT TINY LAB PRO</p><h2 className="mt-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl">从“我正好需要”，到“你也能直接用”。</h2></div><div><p className="max-w-2xl text-base leading-8 text-blue-100/75">这里不是庞大的软件商店，而是一间持续实验的小工坊。每个工具都从具体问题出发，先把核心功能做好，再根据真实使用反馈一点点更新。</p><a href="https://github.com/tinyproductlab" target="_blank" rel="noreferrer" className="mt-7 inline-flex items-center gap-2 font-semibold text-white hover:text-blue-200">在 GitHub 查看开源项目 <ArrowUpRight className="size-4" /></a></div></div></section>

    <section className="bg-white px-5 py-20 sm:px-8"><div className="mx-auto max-w-7xl">
      <div className="flex flex-col justify-between gap-8 rounded-[28px] bg-[#eef2ff] p-7 sm:flex-row sm:items-center sm:p-10">
